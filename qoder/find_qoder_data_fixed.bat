...
if exist "%QODER_PATH%" (
    ...
    powershell -Command "[Console]::OutputEncoding = [System.Text.Encoding]::UTF8; (Get-ChildItem '%QODER_PATH%' -Recurse -ErrorAction SilentlyContinue | Measure-Object -Property Length -Sum).Sum / 1MB" > temp_size.txt 2>nul
